...
let selectlen = document.getElementById('select-len');
let btn = document.querySelector('.convert');
let btnlen = document.querySelector('.convert-len');
...
input.placeholder = `Enter ${selectValue}.....`;
...
console.log(selectValue);
input2.placeholder = `Enter ${selectValue}.....`;
